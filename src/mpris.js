...
import { Destroyable, omit, getSignalHolder, manageSource } from './fubar.js';
...
export class MprisPlayer extends Destroyable {
    ...
    async _buildWidgets() {
        ...
        this._src = manageSource(this, () => this.emit('closed', true), {
    ...
    async _setPlayer(bus_name) {
        ...
        try {
            ...
            this._mpris.connectObject('notify::g-name-owner', () => this._onMprisOwned(), getSignalHolder(this));
            this._player.connectObject('g-properties-changed', this._onPlayerChanged.bind(this), getSignalHolder(this));
            this._onPlayerReady();
            this._onMprisOwned();
        } catch(e) {
            logError(e);
    ...
    _onMprisOwned() {
        ...
        this._src.player.removeSource();
        ['_mpris', '_player'].forEach(x => this[x]?.disconnectObject(getSignalHolder(this)));
    ...
    _onPlayerReady() {
        this._src.player.refreshSource();
